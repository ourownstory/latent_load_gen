...
parser.add_argument('--mode',      type=str, default='val',help="Flag for train, val, test, plot")
...
# choose model
if args.model == 'gmcvae':
    model = GMCVAE(z_dim=args.z, name=model_name, x_dim=24, warmup=(args.warmup==1), var_pen=args.var_pen,
                   k=args.k).to(device)
